...
Tous les comptes de l\'application APERO ont été réinitialisés.
...
Les Administrateurs APERO';
	...
	$resultTruncate = mysqli_query($co, "TRUNCATE compteenfant") or die("Impossible d'exécuter la requête de reinitialisation des tables.");
	$resultTruncate = mysqli_query($co, "TRUNCATE parent") or die("Impossible d'exécuter la requête de reinitialisation des tables.");
	$resultTruncate = mysqli_query($co, "TRUNCATE enfant") or die("Impossible d'exécuter la requête de reinitialisation des tables.");
?>